...
insert into course values(59,'公共财政管理','公共财政管理是一门综合性的课程，它既要涉及到财政学的内容，又要涉及到管理学的内容；它既要对现实政府财政管理活动实际运作状况进行反映，又不能仅仅停留在对各种规章制度和实际做法的繁琐介绍上。因此，在教学中必须注重将《财政学》和《管理学》的理论知识融会贯通于对财政管理实践活动的讨论分析之中；注重让学生认识和把握财政管理活动内容的整体性和体系感，并通过到实际部门调研增加学生对实际财政管理工作的感性认识。',null);
=======
